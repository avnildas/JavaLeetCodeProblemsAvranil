        ...
        if (nums.length >= 1 && nums.length <= 100 && val >= 0 && val <= 100) {
            for (int i = 0; i < nums.length; i++) {
                if (nums[i] == val) {
                    ...
                    numsLengthPostRemoval++;
                    System.out.println("numsLengthPostRemoval : " + numsLengthPostRemoval);
                }
            }
            numsLengthPostRemoval = nums.length - numsLengthPostRemoval;
        }

        return numsLengthPostRemoval;
    }
}
